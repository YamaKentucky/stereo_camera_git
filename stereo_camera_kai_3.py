...
def calculate_moment_left(j):
    im_l = cv2.imread(directory_left +str(j)+'.png')
    print "loading..." + "left" + str(j) + ".png"
...
def calculate_moment_right(k):
    im_r = cv2.imread(directory_right+str(k)+'.png')
    print "loading..." + "right" + str(k) + ".png"
